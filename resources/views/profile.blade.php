...
-->
	...
	<!-- stylesheet css -->
    @vite(['resources/css/profile.css', 'resources/css/bootstrap.min.css','resources/css/font-awesome.min.css','resources/js/avatar.js'])
</head>
@yield('menu')
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12 col-sm-12">
				...
				<h1 class="tm-title bold shadow">Hello {{$username}}</h1>
