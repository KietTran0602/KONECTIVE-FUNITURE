...
let checklength = new RegExp("^(?=.{8,20})");
 checkupper = new RegExp("^(?=.*[A-Z])");
 checknum = new RegExp("^(?=.*[0-9])");
 PassWordSignUp = document.querySelector('#Sign-Up > form > input:nth-child(5)');
 RePassWordSignUp = document.querySelector('#Sign-Up > form > input:nth-child(7)');
 PassWordSignIn = document.querySelector('#Sign-In > form > input:nth-child(5)');
 checkbox = document.querySelector('.checklist').getElementsByTagName('li');
//hide password
